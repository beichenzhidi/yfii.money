                ...
                <Grid item>
                    <Grid container alignItems="center" spacing={2}>
                        <Grid item>
                            <Avatar
                                alt={pool.token}
                                src={require(`../../../images/YFII-logo.png`)}
                            />
                        </Grid>
                    ...
                    <Grid item container justify="space-between">
                        ...
                        <Hidden mdDown>
                            <Grid item xs={3} container justify='center' alignItems="center">
                                <Grid item style={{width: "200px", textAlign: "center"}}>
                                    ...
                                    <Typography className={classes.iconContainerSubTitle} variant="body2">{t('Grant-Price')}</Typography>
                                </Grid>
                            </Grid>
                        </Hidden>
                        <Grid item xs={3} container justify='center' alignItems="center">
                            <Grid item style={{ textAlign: "center" }}>
                                ...
                                <Typography className={classes.iconContainerSubTitle} variant="body2">{t('Grant-Total')}</Typography>
                            </Grid>
                        </Grid>
                        <Grid item xs={12} md={3} container justify='center' alignItems="center">
                            <Grid item style={{ textAlign: "center" }}>
                                ...
                                <Typography className={classes.iconContainerSubTitle} variant="body2">{t('Grant-Ratio')}</Typography>
                            </Grid>
                        </Grid>
                    </Grid>
                </Grid>
